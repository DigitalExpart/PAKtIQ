...
-- This will create all notification functions

-- Step 1: Create function to send reminder notifications
...
-- Step 2: Create function to send daily motivation notifications
...
-- Step 3: Create function to check and notify about upcoming milestones
...
-- Step 4: Create function to check and notify about missed milestones
...
-- Step 5: Create master function that runs all notification checks
